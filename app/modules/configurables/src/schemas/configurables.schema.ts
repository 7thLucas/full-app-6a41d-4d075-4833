...
export const configurableSchemas: ConfigurableSchemas = {
  formSchema: [
    ...
    // White-label tiers
    {
      fieldName: "whitelabelTiers",
      type: "array",
      label: "White-Label Tiers",
      item: {
        type: "object",
        fields: [
          { fieldName: "name", type: "string", required: true, label: "Tier Name" },
          { fieldName: "price", type: "string", required: true, label: "Price ($/mo)" },
    ...
    // Governor names
    {
      fieldName: "governorNames",
      type: "object",
      required: false,
      label: "AI Governor Names",
      fields: [
        { fieldName: "architect", type: "string", required: false, label: "Architect Governor Name" },
        { fieldName: "integrity", type: "string", required: false, label: "Integrity Governor Name" },
        { fieldName: "stability", type: "string", required: false, label: "Stability Governor Name" },
        { fieldName: "acquisition", type: "string", required: false, label: "Acquisition Governor Name" },
      ],
    },
    // Feature flags
    {
      fieldName: "enableWhitelabel",
      type: "boolean",
      required: false,
      label: "Enable White-Label System",
    },
    {
      fieldName: "enableConsultingEngine",
      type: "boolean",
      required: false,
      label: "Enable Consulting Engine",
    },
    {
      fieldName: "enableLeadEngine",
      type: "boolean",
      required: false,
      label: "Enable Lead Engine",
    },
    {
      fieldName: "enableMarketplace",
      type: "boolean",
      required: false,
      label: "Enable AI Marketplace",
    },
    // Consulting pricing
    {
      fieldName: "consultingPriceRange",
      type: "string",
      required: false,
      label: "Consulting Price Range",
    },
    {
